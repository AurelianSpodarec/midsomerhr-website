...
function SectionHero() {
  return (
    <Section id="hero" color="clean" className="h-screen bg-[#faf9f9]">
      ...
      <div className="absolute w-[30px] top-[120px] left-[30px]">
        <Icon />
      </div>
      ...
      <Container>
        <div className="flex">
          ...
          <div>
            <h1 className="text-8xl font-bold font-playFair leading-[0.85] max-w-screen-md mb-4 mt-20"><span className="hand-underline">Personalized</span> HR Support for Small Businesses</h1>
            ...
            <div className="mt-6 space-x-4">
              <button className="hidden lg:inline-flex nav-cta bg-[#131313] rounded-lg border py-3 px-4 text-white">Schedule a Call</button>
          ...
          <div className="absolute top-16 right-20">
            <div className="relative h-[580px] cursor-pointer">
              ...
              />
              <svg className="absolute w-16 h-16 z-10 top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 52.821 52.821">
                <g>
